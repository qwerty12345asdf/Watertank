...
void buildWebsite(){
  ...
  webSite +=javaScript;
   ...
   webSite += "<body onload='process()'>";
    ...
    webSite +="<table border='0'><tr><td><div align='right'>Height of water-tank(in cm):</div></td> <td><input type='number' name='total_height' max='2000' required> &nbsp<a style='color:grey'>Default value</a><a style='color:grey' id='total_height'></a></td></tr> ";
...
void buildXML(){
  ...
  XML+="<lower_percentage_water_in_tank>"+String(lower_percentage_water_in_tank)+"</lower_percentage_water_in_tank>";
