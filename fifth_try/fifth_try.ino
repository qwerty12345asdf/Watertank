...
const char* ssid="Omkar";//the wifi network i am connecting to 
const char* pass="";//the password of the wifi netw.
//const char* pass_sent="2345";//the pass. to protect the webSite
...
void buildWebsite(){
  ...
  webSite +=javaScript;
   ...
   webSite += "<body onload='process()'>";
    ...
    webSite += "<h1><br>Water-Tank access:<div> Percentage Water in Tank:<a id='percentage_water_in_tank' ></a>% </div><div align='right' id='current_time_date'>Time will be shown here...<div></h1>";  
   ...
   /* webSite += "Height of water-tank(in cm):<input type='number' name='total_height' max='2000' required><br>";
    ...
    webSite += "</form><br><br>";*/
    webSite +="<br>Control servo:&nbsp <input type='button' onclick='turnOnServo()' value='Turn ON' > &nbsp <input type='button' onclick='turnOffServo()' value='Turn OFF' >";
    webSite +="";
    webSite += "</body>";
    webSite += "</html>";
}
...
String digitalClockDisplay()
{
  ...
  return s1_time_date; // returns time and date when called by xml
